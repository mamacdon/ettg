...
/*jslint regexp:false*/
define([], function() {
	var Grammar, Rule, Nonterminal, Terminal, Trail;

	function randRange(min, max) {
		return Math.floor(Math.random()*max + min);
	}

	var START_SYMBOL_NAME = 'start';
	/**
	 * Grammar
	 */
	Grammar = function() {
	 ...
	 * Nonterminal
	 */
	Nonterminal = function(nonTerminalName, grammar) {
...
//		}
	...
	/**
	 * A shitty parser that builds a Grammar from an input file in BNF-ish format
	 * Basically the format needs to be:
	 *  <start> := start | <blah>;;
	 *  <blah> := blah;;
	 */
	function GrammarParser(fileText) {
